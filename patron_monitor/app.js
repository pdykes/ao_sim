...
var listener_target = database_url + db_name;
...
feed.since         = 'now';
feed.include_docs  = 'true';  // new PJD
...
feed.on('change', function(change) {
  ...
  console.log("Change detected: ", JSON.stringify(change.id, null, 4));
  console.log("Retrieving updated record from:", listener_target);
    
/* simplify    PJD - need to test this out...
...
*/
  ...
  console.log('change document:', JSON.stringify(change.doc, null, 4));
